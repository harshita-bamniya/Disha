...
// Only used here, so kept local rather than in constants.ts.
...
export function PreferencesSection({ profile, open, onToggle }: { profile: ProfileData; open: boolean; onToggle: () => void }) {
