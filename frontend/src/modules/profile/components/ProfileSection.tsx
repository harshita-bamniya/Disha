import { ChevronUp, Pencil, Check, FileText } from 'lucide-react'
import { SECTION_META } from './profileConstants'
...
export function ProfileSection({ title, summary, isOpen, onToggle, children, saving, saved }: SectionProps) {
  ...
  return (
    <div style={{
      ...
      boxShadow: isOpen ? '0 12px 36px rgba(15,23,42,0.10)' : '0 2px 10px rgba(15,23,42,0.04)',
      overflow: 'hidden',
      transition: 'all 0.3s ease',
    }}>
      {isOpen && <div style={{ height: 3, background: '#1A2744' }} />}
      ...
      {isOpen && (
        <div style={{ padding: '0 22px 24px', borderTop: '1px solid rgba(59,130,246,0.06)' }}>
