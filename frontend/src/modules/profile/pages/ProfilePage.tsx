...
// Split into modules/profile/components/* (audit L-07/Sprint 6: this file
// was ~918 lines with 7 section components + a shared Section wrapper +
// KrsPanel all defined inline). Same markup and logic throughout, just
// relocated — see each component file for what moved where.
